  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <img src = {up} className="arrow1" onClick={(e) => handleChange("increment", "h")}></img>
        
      
        <img src = {down} className="arrow6"onClick={(e) => handleChange("decrement", "h")}></img> 
        
        
        <img src = {up} className="arrow3"onClick={(e) => handleChange("increment", "m")}></img>
        
      
        <img src = {down} className="arrow2" onClick={(e) => handleChange("decrement", "m")}></img>
      
      
        <img src = {up} className="arrow5" onClick={(e) => handleChange("increment", "s")}></img>
        
      
        <img src = {down} className="arrow4" onClick={(e) => handleChange("decrement", "s")}></img>
      ...
      <p clasName ="nama">Leonardo Steven 00000037279</p>
      </header>
    </div>
  );
}
